...
- **`DECIDED` The collapsed rail shows role abbreviations, not dots.** PD · UXR · DS · VD · BD · 3D · MD · GD · IL · AN · VE, from a new `abbr` field in the seed. A rail of eleven identical dots is not navigable, and there are no per-role icons to fall back on.
